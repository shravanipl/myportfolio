...
$(document).ready(function() {
	...
	$('header[data-type="background"], section[data-type="background"]').each(
		function() {
	...
	$(window).scroll(function() {
		...
		$("header[role='banner']").toggleClass(
			'shadowed',
			$(this).scrollTop() > 700
		);
